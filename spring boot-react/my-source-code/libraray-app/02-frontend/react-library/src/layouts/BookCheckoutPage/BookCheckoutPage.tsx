...
import { CheckoutAndReviewBooks } from "./CheckoutAndReviewBooks";
...
export const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        const fetchUserCheckdeOutBook = async () => {
            if(authState && authState.isAuthenticated){
        ...
        fetchUserCheckdeOutBook().catch((error: any) => {
            setIsLoadingBookCheckedOut(false);
            setHttpError(error.message);
        })
        ...
        <div>
            <div className='container d-none d-lg-block'>
                ...
                <div className='row mt-5'>
                    ...
                    <CheckoutAndReviewBooks book={book} mobile={false} currentLoansCount={currentLoansCount} 
            ...
            {displayError && <div className="alert alert-danger mt-3" role="alert">
                ...
                <CheckoutAndReviewBooks book={book} mobile={true} currentLoansCount={currentLoansCount}
                isAuthenticated={authState?.isAuthenticated} isCheckedOut={isCheckedOut} checkoutBook={checkoutBook}
                isReviewLeft={isReviewLeft} submitReview={submitReview}/>
                <hr />
